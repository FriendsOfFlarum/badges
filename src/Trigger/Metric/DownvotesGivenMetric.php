...
class DownvotesGivenMetric implements MetricInterface
{
    ...
    {
        return 'downvotes_given';
    }

    public function getTranslationKey(): string
    {
        return 'fof-badges.admin.metrics.downvotes_given';
    }
    ...
    public function getEventTriggers(): array
    {
        if (class_exists(\FoF\Gamification\Events\PostWasVoted::class)) {
            return [
                \FoF\Gamification\Events\PostWasVoted::class => fn ($event) => $event->vote->user,
            ];
        }
